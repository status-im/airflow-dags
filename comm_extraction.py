...
def comm_extraction():
    ...
    connections_id >> [discord_fetcher, simplecast_fetch] >> twitter_acid_info  >> twitter_nomos_tech  >> twitter_codex  >> twitter_ethstatus  >> twitter_logos  >> twitter_waku  >> twitter_nimbus  >> dbt_run_socials
